  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        ...
        <div className="border-b border-gray-200 py-2">
          <p className="text-sm font-semibold text-gray-700">Currency Unit</p>
          <p className="text-lg font-semibold text-gray-700">
      ...
      <div className="mt-6">
        <h2 className="text-xl font-bold text-gray-800 ">Settings Details</h2>
        ...
        <div className="border-b border-gray-200 py-2">
          <p className="text-sm font-semibold text-gray-700">Maximum Balance</p>
          <p className="text-lg font-semibold text-gray-700">
            N
            {new Intl.NumberFormat(singalAccountData?.lang || "en", {}).format(
